...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.print = exports.pipeAsync = exports.pipe = void 0;
...
const csvtojson_1 = __importDefault(__nccwpck_require__(7463));
const common_1 = __nccwpck_require__(9901);
...
const fetchBggRankings = (url) => __awaiter(void 0, void 0, void 0, function* () {
    return axios_1.default
        .get(url)
        .then((response) => response.data)
        .then((csvData) => csvtojson_1.default().fromString(csvData))
        .then((jsonArray) => jsonArray[0]);
});
const getHistoricalRankings = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield common_1.pipeAsync(getFormattedDate, buildHistoricalRankingsUrl, fetchBggRankings, common_1.print)('');
});
