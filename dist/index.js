...
const get_historical_rankings_1 = __nccwpck_require__(7008);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            get_historical_rankings_1.getHistoricalRankings();
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getHistoricalRankings = void 0;
...
const buildHistoricalRankingsUrl = (formattedDate) => `https://raw.githubusercontent.com/beefsack/bgg-ranking-historicals/master/${formattedDate}.csv`;
const fetchBggRankings = (url) => __awaiter(void 0, void 0, void 0, function* () { return axios_1.default.get(url).then(response => response.data); });
const printValue = (value) => {
    console.log('printValue: ', value.length);
};
const getHistoricalRankings = () => __awaiter(void 0, void 0, void 0, function* () {
    yield pipeAsync(getFormattedDate, buildHistoricalRankingsUrl, fetchBggRankings, printValue)('');
});
exports.getHistoricalRankings = getHistoricalRankings;
